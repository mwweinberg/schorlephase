...
//stepper variables
//number of steps for the motor (from the spec sheet)
#define STEPS 200
//how far you want the thing to travel
int distance = 6000;
...
void setup() {
  ...
  // speed in RPM - 100 is the max speed
...
void turnoff() {
  ...
  //*****stepper section
  // goes down distance steps (down because it is negative)
  stepper.step(-distance);
